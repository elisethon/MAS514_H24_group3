...
class OdometryPublisher(Node):
    def __init__(self):
        ...
        # Static Transform Broadcaster for world -> odom and world -> map
    ...
    def broadcast_static_transforms(self):
        """Broadcast static transforms for world -> odom and world -> map."""
        # world -> odom
        ...
        world_to_odom.transform.rotation.w = 1.0  # Identity quaternion (no rotation)
        ...
        self.static_tf_broadcaster.sendTransform([world_to_odom, world_to_map])
