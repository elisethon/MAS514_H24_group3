...
def generate_launch_description():
    ...
    bno055_launch_path = os.path.join(
        get_package_share_directory('bno055'), 'launch', 'bno055_launch.py'  # Adjust if needed
    )

    return LaunchDescription([
        # Declare arguments to selectively launch components
        ...
        DeclareLaunchArgument('use_serial', default_value='true', description='Launch teleop and joint state publisher'),

        # Teleop and Joint State Publisher
        Node(
            package='robin_SAS',
