...
class OdometryPublisher(Node):
    def __init__(self):
        ...
        self.velocity_l_msg = 0.0
        self.velocity_r_msg = 0.0
    ...
    def publish_velocity(self):
        ...
        self.velocity_l_msg.data = self.left_wheel_velocity/self.wheel_radius
        self.velocity_r_msg.data = self.right_wheel_velocity/self.wheel_radius
        self.left_pub.publish(self.velocity_l_msg)
