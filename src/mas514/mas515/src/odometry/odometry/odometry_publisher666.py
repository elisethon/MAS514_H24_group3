...
class OdometryPublisher(Node):
    ...
    def filtered_odometry_callback(self, msg):
        """Callback to update base_link with filtered odometry."""
        # Publish the filtered odometry message to odom topic
        self.odom_pub.publish(msg)

        # Broadcast transform from odom to base_link using the filtered data
        t = TransformStamped()
    ...
    def publish_odometry(self):
        ...
        odom_msg.header.frame_id = 'world'  # Updated frame_id
        odom_msg.child_frame_id = 'odom_r'  # Updated child_frame_id
        ...
        odom_msg.pose.covariance[0] = 0.01  # x covariance
        odom_msg.pose.covariance[7] = 0.01  # y covariance
        odom_msg.pose.covariance[35] = 0.02  # theta covariance
        odom_msg.twist.covariance[0] = 0.01  # linear x velocity covariance
        odom_msg.twist.covariance[35] = 0.02  # angular z velocity covariance
